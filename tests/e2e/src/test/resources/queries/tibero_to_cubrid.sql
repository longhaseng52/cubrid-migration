...
-- values for numeric_types are conservative — see comments in
-- db/tibero/main_schema/V99__data.sql §5.2 for the Tibero importer
-- limitation that constrains them.
