-- ============================================================
-- MAIN_SCHEMA (MariaDB): type test tables.
--
...
-- MariaDB -> CUBRID type mapping. ENUM/SET/JSON are omitted for parity with the
-- MySQL seed (CMT could not extract those types there).
-- ============================================================
