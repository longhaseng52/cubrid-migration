-- ============================================================
-- MAIN_SCHEMA (MariaDB): business graph tables, indexes, check constraints.
--
-- Mirrors the Oracle business dataset in MariaDB 11 dialect (MySQL-compatible).
-- Ids are inserted explicitly (see V99). utf8mb4 covers the multilingual columns
-- Oracle modelled with NVARCHAR2. CHECK constraints are enforced from MariaDB
-- 10.2+. The MySQL 8 functional index is dropped (MariaDB has no ((expr)) index).
-- ============================================================
